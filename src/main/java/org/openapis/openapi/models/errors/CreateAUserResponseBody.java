...
/**
 * CreateAUserResponseBody - 401
 */
public class CreateAUserResponseBody extends RuntimeException {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateAUserResponseBody withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateAUserResponseBody withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
