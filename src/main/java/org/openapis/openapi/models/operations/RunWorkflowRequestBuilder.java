...
public class RunWorkflowRequestBuilder {
    ...
    private Optional<? extends RunWorkflowRequestBody> request = Optional.empty();
    ...
    public RunWorkflowRequestBuilder request(RunWorkflowRequestBody request) {
        Utils.checkNotNull(request, "request");
        this.request = Optional.of(request);
        return this;
    }

    public RunWorkflowRequestBuilder request(Optional<? extends RunWorkflowRequestBody> request) {
        Utils.checkNotNull(request, "request");
