...
public class GetWorkflowErrorsRequest {
    ...
    @JsonCreator
    public GetWorkflowErrorsRequest(
            String workflowId,
     ...
     * The Id of the workflow you want to find errors for
     */
    public GetWorkflowErrorsRequest withWorkflowId(String workflowId) {
        Utils.checkNotNull(workflowId, "workflowId");
        this.workflowId = workflowId;
        return this;
    }
     ...
     * The Id of the user you want delete logs for. Returned from the Create User endpoint
     */
    public GetWorkflowErrorsRequest withUserId(String userId) {
        Utils.checkNotNull(userId, "userId");
     ...
     * The Id of the user you want delete logs for. Returned from the Create User endpoint
     */
    public GetWorkflowErrorsRequest withUserId(Optional<? extends String> userId) {
        Utils.checkNotNull(userId, "userId");
        this.userId = userId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetWorkflowErrorsRequest other = (GetWorkflowErrorsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetWorkflowErrorsRequest.class,
    ...
    public final static class Builder {
        ...
        public GetWorkflowErrorsRequest build() {
            return new GetWorkflowErrorsRequest(
                workflowId,
                userId);
        }
    }
