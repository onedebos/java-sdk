...
public class ListIntegrationsData {
    ...
    private Optional<? extends java.util.List<Workflows>> workflows;

    @JsonCreator
    public ListIntegrationsData(
            ...
            @JsonProperty("workflows") Optional<? extends java.util.List<Workflows>> workflows) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<Workflows>> workflows() {
        return (Optional<java.util.List<Workflows>>) workflows;
    }
    ...
    public ListIntegrationsData withIntegrationId(String integrationId) {
        Utils.checkNotNull(integrationId, "integrationId");
        this.integrationId = Optional.ofNullable(integrationId);
        return this;
    }

    public ListIntegrationsData withIntegrationId(Optional<? extends String> integrationId) {
        Utils.checkNotNull(integrationId, "integrationId");
        this.integrationId = integrationId;
        return this;
    }

    public ListIntegrationsData withApp(String app) {
        Utils.checkNotNull(app, "app");
        this.app = Optional.ofNullable(app);
        return this;
    }

    public ListIntegrationsData withApp(Optional<? extends String> app) {
        Utils.checkNotNull(app, "app");
        this.app = app;
        return this;
    }

    public ListIntegrationsData withInstalled(boolean installed) {
        Utils.checkNotNull(installed, "installed");
        this.installed = Optional.ofNullable(installed);
        return this;
    }

    public ListIntegrationsData withInstalled(Optional<? extends Boolean> installed) {
        Utils.checkNotNull(installed, "installed");
        this.installed = installed;
        return this;
    }

    public ListIntegrationsData withIcon(String icon) {
        Utils.checkNotNull(icon, "icon");
        this.icon = Optional.ofNullable(icon);
        return this;
    }

    public ListIntegrationsData withIcon(Optional<? extends String> icon) {
        Utils.checkNotNull(icon, "icon");
        this.icon = icon;
        return this;
    }

    public ListIntegrationsData withWorkflows(java.util.List<Workflows> workflows) {
        Utils.checkNotNull(workflows, "workflows");
        this.workflows = Optional.ofNullable(workflows);
        return this;
    }

    public ListIntegrationsData withWorkflows(Optional<? extends java.util.List<Workflows>> workflows) {
        Utils.checkNotNull(workflows, "workflows");
        this.workflows = workflows;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListIntegrationsData other = (ListIntegrationsData) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListIntegrationsData.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<Workflows>> workflows = Optional.empty();  
        ...
        public Builder workflows(Optional<? extends java.util.List<Workflows>> workflows) {
            Utils.checkNotNull(workflows, "workflows");
            this.workflows = workflows;
            return this;
        }
        
        public ListIntegrationsData build() {
            if (installed == null) {
                installed = _SINGLETON_VALUE_Installed.value();
            }
            return new ListIntegrationsData(
                integrationId,
                app,
                installed,
                icon,
